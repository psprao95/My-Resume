...
\section{Technical Skills}
   ...
   \resumeSubHeadingListStart
    ...
    \resumeSubItem{Languages: }{C++, SQL, Java (basic), Python}
     \resumeSubItem{Web Technologies: }{HTML, CSS, JavaScript, PHP, jQuery, AJAX, RESTful APIs, Mean Stack}
     \resumeSubItem{Strong areas} {Algorithms, Data Structures}
     \resumeSubItem{Tools} {MySQL , MAMP, Eclipse, IntelliJ,  Clion, Git, Atom}
